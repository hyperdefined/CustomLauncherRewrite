...
sudo wget -q -O ~/.local/share/icons/custom-rewrite-launcher.png https://github.com/hyperdefined/CustomLauncherRewrite/blob/master/src/main/resources/icon.png
